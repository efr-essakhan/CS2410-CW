...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">History of all adopton requests made by a user and whether they were approved
                    or denied.
                </div>
                    ...
                    <table class="table table-hover table-dark">
                        <div style="color:blue" class="card" style="width: 18rem;">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><b> User ID: </b> {{$user->id}} <br> <b> email:</b>
                                    {{$user->email}}</a></li>
                            </ul>
                        </div>
